...
// Importaciones corregidas a rutas relativas
import { Button } from "@/components/ui/button.jsx";
import UpdateButton from "@/components/ui/UpdateButton.jsx";
import useHero from "../hooks/useAuth.js" 
import useAuth from "../hooks/useAuth.js"; // Corregida la ruta del hook de autenticación

const HeroSection = () => {
  // 1. Desestructurar estados de Hero (datos de la base de datos)
  const {
    heroes,
    isLoading,
    error,
  ...
  // Extraer los datos y el ID del primer héroe
  ...
  const editableClass =
    "p-1 rounded-md transition-colors duration-200 border border-transparent focus:border-blue-400 focus:bg-white resize-none outline-none text-center";
  const viewClass = "p-1";

  // El estado de carga final debe considerar ambos: la autenticación y la carga de datos del héroe
            ...
            <>
                ...
                <span className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 text-blue-800 text-sm font-medium">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      style={{
                        width: `${(formData.city.length > 0 ? formData.city.length : 1) * 0.75}em`,
                      }}
                    />
                  ) : (
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                ...
                {isEditing ? (
                  ...
                  // Botones en Modo Vista (incluyendo el de Edición Condicional)
                  <>
                    <Button
                    ...
                    {/* Botón para entrar en modo edición (AHORA CONDICIONAL) */}
                    {/* Solo visible si el usuario está autenticado (currentUser es truthy) */}
                    {currentUser && (
                      <Button
              ...
              {/* Scroll Indicator (Solo visible en modo vista y si NO estamos editando) */}
              {!isEditing && (
